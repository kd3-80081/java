...
public class TestQ2 {
	...
	public static void writeBooks(List<Book> list) {
		...
		try (FileOutputStream fout = new FileOutputStream("/home/sunbeam/Booksobject.txt")) {
	...
	public static void readBooks(List<Book> list) {
		try(FileInputStream fin = new FileInputStream ("/home/sunbeam/Booksobject.txt")){
	...
	public static void main(String[] args) {
		...
		list.add(book = new Book("1002", 93.0, "parveen", 2));
		list.add(book = new Book("1003", 550.0, "revan", 10));
		list.add(book = new Book("1004", 6660.0, "Mubeen", 18));
		list.add(book = new Book("1005", 433.0, "karen", 32));
		list.add(book = new Book("1006", 320, "mavrik", 42));
